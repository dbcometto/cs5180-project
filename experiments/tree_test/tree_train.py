...
friend = Agent(policy)
friend.train(train_env,epochs=1000,batch_size=5,optimizer_epochs=5,clip_epsilon=0.2,start_seed=2025,gamma=0.99, folderpath = folderpath, checkpoint_interval = 100, resume_epoch=146)
