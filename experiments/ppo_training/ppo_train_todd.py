...
seed= 2025
train_env = TreeWorld(render_mode=None, step_limit=199, obs_as_tensor=True, use_fixed_map=False, do_smooth_complete_reward=True, do_smooth_end_dist=True)
...
try:
    friend.train(train_env,epochs=100_000, batch_size=32, optimizer_epochs=8, clip_epsilon=0.2, 
                 ...
                 folderpath = folderpath, checkpoint_interval = 100, resume_epoch=241)
