...
demo_env = TreeWorld(render_mode="human",step_limit=499, obs_as_tensor=True, use_fixed_map=False, enable_extra_channels=True, do_gate_ending=True, enable_extra_dist_channel=True)
