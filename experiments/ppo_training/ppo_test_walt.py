...
test_env = TreeWorld(render_mode=None, step_limit=999,
                     obs_as_tensor=True, use_fixed_map=False, enable_extra_channels=True, 
                     do_smooth_complete_reward=True, do_smooth_end_dist=True, do_gate_ending=True)

friend_test = friend.test(test_env,episodes=25,runs=4,start_seed=2025, folderpath=friend_folderpath, test_name=test_name, gamma=gamma)
